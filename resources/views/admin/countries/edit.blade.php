...
<div class="box">
  ...
  <div class="box-body">
   ...
   <div class="form-group">
        ...
        <select name='country_name_en' value="{{old('country_name_ar')}}" class='form-control'>
  ...
  <option value="زيمبابوي">زيمبابوي</option>
     ...
     <div class="form-group">
        ...
        <select name='country_name_en' value="{{old('country_name_en')}}" class='form-control'>
     ...
     <div class="form-group">
        ...
        <select name='mob' value="{{old('mob')}}" class='form-control'>
